      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-gray-600 mt-4">
              <li>
                Assist Law Enforcement and Respond to Legal Requests: We may
                work with the appropriate law enforcement agencies to
                investigate and prosecute any fraudulent or criminal activity on
                our Site.
              </li>
              <li>
                Deliver Targeted Advertising: We may use information collected
                about you to deliver targeted advertising or marketing offers.
              </li>
              <li>
                Request Feedback: We may use your information to request
                feedback and to contact you about your use of our Site.
              </li>
              <li>
                Improve Our Services: We may use your information to improve our
                Site and services.
              </li>
            </ul>
          </section>
